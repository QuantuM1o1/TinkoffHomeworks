...
public class Task20Test {
    @Test
    @DisplayName("Читабельные ошибки")
    void readableErrors() {
        // given
        ...
        // when
        Map<String, String> answer = Task20.moreReadableErrorMessages(test);

        // then
        assertThat(answer.get("Freddi")).isEmpty();
        assertThat(answer.get("Mrs. Norris")).isEqualTo("Name");
        assertThat(answer.get("Bastet")).isEqualTo("Height, Weight");
        assertThat(answer.get("Leviathan")).isEqualTo("Age");
    }
}
